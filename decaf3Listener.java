...
public interface decaf3Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link decaf3Parser#declaration}.
	 * @param ctx the parse tree
	 */
	void enterDeclaration(decaf3Parser.DeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link decaf3Parser#declaration}.
	 * @param ctx the parse tree
	 */
	void exitDeclaration(decaf3Parser.DeclarationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link decaf3Parser#structSingle}.
	 * @param ctx the parse tree
	 */
	void enterStructSingle(decaf3Parser.StructSingleContext ctx);
	/**
	 * Exit a parse tree produced by {@link decaf3Parser#structSingle}.
	 * @param ctx the parse tree
	 */
	void exitStructSingle(decaf3Parser.StructSingleContext ctx);
	/**
